      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <section className="space-y-4 lg:col-span-2">
          ...
          <div className="overflow-hidden rounded-lg border border-gray-200 bg-white">
            ...
            <div className="space-y-4 p-6">
              ...
              {p.descripcion && (
                <div>
                  <h3 className="text-[11px] font-bold uppercase tracking-wider text-gray-500">Descripción</h3>
              ...
              <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                {p.incluye && (
                  <div>
                    <h3 className="text-[11px] font-bold uppercase tracking-wider text-gray-500">Incluye</h3>
                    <p className="mt-1 whitespace-pre-wrap text-sm text-gray-700">{p.incluye}</p>
                  </div>
                )}
                {p.no_incluye && (
                  <div>
                    <h3 className="text-[11px] font-bold uppercase tracking-wider text-gray-500">No incluye</h3>
          ...
          <section className="rounded-lg border border-gray-200 bg-white">
            <header className="flex items-center justify-between border-b border-gray-100 px-5 py-3">
              <h2 className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-wider text-gray-500">
                ...
                <span className="ml-1 rounded-full bg-gray-100 px-2 py-0.5 text-[10px] font-semibold text-gray-700">{ops.length}</span>
              </h2>
            </header>
            {ops.length === 0 ? (
        ...
        <aside className="space-y-3 lg:col-span-1">
          <div className="rounded-lg border border-gray-200 bg-gray-50 p-5">
            <p className="text-[11px] font-bold uppercase tracking-wider text-gray-500">Precio desde</p>
